...
if domainname  == "millennium.berkeley.edu"
    if isdirectory("/scratch/david.detomaso/.nvim")
        call plug#begin("/scratch/david.detomaso/.nvim/plugged")
    else
    ...
    set directory=/data/yosef2/users/david.detomaso/.nvim/swap
else
    call plug#begin()
endif
...
if filereadable(expand("/scratch/david.detomaso/.config/nvim/init.vim"))
  source /scratch/david.detomaso/.config/nvim/init.vim
endif
